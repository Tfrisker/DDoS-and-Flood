...
# HTTP-ENGINE PENTEST TOOL.
# //Coded By Engin Canpolat 2020
  ...
  ********  ****************    ||
   *******  ****************    ||
        ** *****************    ||
           ...
           *****************    ||
           ******************   ||  ========================
          *******************   ||  Coded By Engin Canpolat     
          ********************  ||  HTTP-BYPASS Http Dos Tool
          ********************  ||  ========================
         ********************** ||
       **************************
...
if($#ARGV > 2) {
	...
	die("______________________________________________________________\n                  HTTP-ENGINE.pl by:Engin\n______________________________________________________________\nKullanimi: HTTP-ENGINE [url] [Baglanti] [Gönderilen Baglanti [IP Host\n* [URL]|Site\n* [Baglanti]|Connection\n* [Baglanti İstekleri]|Paketler\n* [localhost]|ip 127.0.0.1\n______________________________________________________________\nEx: HTTP-KILLER.pl http://www.siteadi.com 900 900 127.0.0.1\n");
}